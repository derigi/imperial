     ...
     <?php
	  ...
	  <div class="col-md-6 col-lg-4 mb-5">
        <div class="media-with-text">
          ...
          <p>Hotel airinn Menawarkan Brosur Pernikahan, Sehingga Jikalau klien Ingin Memesan Ballrom Untuk Pesta pernikahan yang Mereka Impikan Dan Pemesanannyapun dapat dilakukan secara online.</p>
        </div>
      </div>
	  <div class="col-md-6 col-lg-4 mb-5">
        <div class="media-with-text">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 mx-auto text-center mb-5 section-heading">
				<h2 class="mb-5">Gallery Hotel imperial</h2>
			</div>
		</div>
