...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Mar 2022 pada 08.05
...
(2, 'Restoran', 'Dengan pemandangan kolam renang dan laut yang indah, AIRINN menyajikan sarapan, makan siang, makan malam dan cemilan lezat menggunakan bahan paling segar untuk pengalaman bersantap yang paling orisinil dan menyenangkan.', 'bar.jpg'),
(3, 'Gym', 'Bagi anda yang suka berolahraga, Kami manajemen Hotel AIRINN juga Menyediakan fasilitas olahraga dan gym, sehingga client juga bisa berolahraga di hotel tanpa harus capek pergi keluar sekedar mencari tempat GYM, dan juga berolahraga di GYM hotel AIRINN juga sangat menyenangkan karena sambil berolahraga juga bisa sambil menikmati sunset di Penghujung senja.', 'gym.jpg'),
...
(5, 'Spa', 'Hotel AIRINN Menyediakan fasilitas SPA bagi para perempuan yang ingin tampil lebih cantik dan memanjakan diri mereka, selain itu petugas SPA juga sangat ramah serta produk yang pakai di SPA Hotel AIRINN di bawah perlindungan dokter kecantikan, jadi di jamin aman untuk kulit client.', 'spa.jpg');
...
(1, 'mercure0.jpg', 'Welcome  to  Hotel Airinn', 'Hotel Kualitas Tinggi'),
