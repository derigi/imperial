...
<div class="panel-heading">
	...
	<tr>
	<td><div align="center">
	<h3><label>HOTEL Imperial </label></h3>
	<label>Jl.Cipatik IV No.19, bandung Barat.</label>
	<label> Kota bandung,jawa barat 20013</label> 
	<label>Telp : (0751) 891188</label> Jl. Cipatik IV No.19, bandung Barat., Kota bandung,jawa barat 20013
	<label>Email : info@imperial.com</label>
